...
class Grumman:
    ...
    def _cl_from_alpha(self, alpha, elevator, q_hat):
        """ Calculate lift coefficient (C_L) from angle of attack (α), elevator deflection, and pitch rate (q_hat)."""
        ...
        # c_lift[mask_high] = (-self.CL_ALPHA * alpha[mask_high]
        #                      + self.CL_0 + 2 * self.CL_ALPHA * self.ALPHA_STALL)
